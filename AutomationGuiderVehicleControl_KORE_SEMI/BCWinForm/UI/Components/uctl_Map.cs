...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctl_Map : UserControl
    {
        ...
        private void initialMapSpace()
        {
            ...
            {
                space_Height_m = 10000; //AT_S 地圖地圖大小
                space_Width_m = 60000;
                zoon_Factor = 70;
                defaultMaxScale = 13;
            }
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_AT_S_BAY1))
            {
                space_Height_m = 60000; //AT_S 地圖地圖大小
                space_Width_m = 60000;
                zoon_Factor = 70;
                defaultMaxScale = 13;
            }
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_AT_S_BAY2))
            {
                space_Height_m = 60000; //AT_S 地圖地圖大小
                space_Width_m = 60000;
                zoon_Factor = 70;
            ...
            else if (BCFUtility.isMatche(mainForm.BCApp.SCApplication.BC_ID, SCAppConstants.WorkVersion.VERSION_NAME_KORE_AGVC))
            {
                space_Height_m = 35000; //AT_S 地圖地圖大小
                space_Width_m = 135000;
                zoon_Factor = 130;
                defaultMaxScale = 10;
            }
