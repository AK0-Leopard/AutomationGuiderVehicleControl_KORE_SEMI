...
namespace com.mirle.ibg3k0.bc.winform.UI
{
    public partial class ReserveSectionInfoForm : Form
    {
        ...
        private async void btn_set_vh_Click(object sender, EventArgs e)
        {
            ...
            float angel = (float)num_angle_for_adr.Value;
            ...
            await Task.Run(() => result = bcApp.SCApplication.ReserveBLL.TryAddVehicleOrUpdate(vh_id, "", map_address_axis.x, map_address_axis.y, angel, 0, vh_sensor_dir, vh_fork_dir));
