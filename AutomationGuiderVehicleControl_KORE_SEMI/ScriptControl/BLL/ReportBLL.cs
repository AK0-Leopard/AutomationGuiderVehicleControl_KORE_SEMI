...
namespace com.mirle.ibg3k0.sc.BLL
{
    ...
    public class ReportBLL
    {
        ...
        public bool newReportUnloadArrivals(string cmdID, List<AMCSREPORTQUEUE> reportqueues,bool forHPRSpecialReport = false)
        {
            ...
            {
                isSuccsess = isSuccsess && iBSEMDriver.S6F11SendVehicleArrived(cmdID, reportqueues, forHPRSpecialReport);
                isSuccsess = isSuccsess && iBSEMDriver.S6F11SendVehicleAcquireStarted(cmdID, reportqueues, forHPRSpecialReport);
        ...
        public bool newReportTransferCommandFinish(string cmdID, List<AMCSREPORTQUEUE> reportqueues, bool forHPRSpecialReport = false)
        {
            bool isSuccsess = true;
            if (forHPRSpecialReport)
            {
                ...
                isSuccsess = isSuccsess && iBSEMDriver.S6F11SendCarrierRemoved(cmdID, reportqueues, forHPRSpecialReport);
            }
        ...
        public bool ReportEmptyFoupRequest(string port_id)
        {
            bool isSuccsess = true;
            isSuccsess = isSuccsess && iBSEMDriver.S6F11SendEmptyFoupRequest(port_id);
            return isSuccsess;
        }
        public bool ReportEmptyFoupDepositFail(string port_id)
        {
            bool isSuccsess = true;
            isSuccsess = isSuccsess && iBSEMDriver.S6F11SendEmptyFoupDepositFail(port_id);
            return isSuccsess;
        }

        public bool ReportdOperatorInitialAction(string command_id, string command_type, string carrier_id, string source, string destination, string priority, List<AMCSREPORTQUEUE> reportQueues = null)
        {
            bool isSuccsess = true;
            isSuccsess = isSuccsess && iBSEMDriver.S6F11SendOperatorInitialAction(command_id, command_type, carrier_id, source, destination, priority, reportQueues);
            return isSuccsess;
        }
