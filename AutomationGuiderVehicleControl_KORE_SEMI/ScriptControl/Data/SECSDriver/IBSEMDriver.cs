...
namespace com.mirle.ibg3k0.sc.Data.SECSDriver
{
    public abstract class IBSEMDriver : SEMDriver
    {
        ...
        public abstract bool S6F11SendVehicleArrived(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        public abstract bool S6F11SendVehicleAcquireStarted(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        public abstract bool S6F11SendVehicleAcquireCompleted(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        ...
        public abstract bool S6F11SendVehicleDepositStarted(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        public abstract bool S6F11SendVehicleDepositCompleted(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        ...
        public abstract bool S6F11SendCarrierRemoved(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        public abstract bool S6F11SendVehicleUnassinged(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null);
        public abstract bool S6F11SendTransferCompleted(string cmdID, List<AMCSREPORTQUEUE> reportQueues = null, bool forHPRSpecialReport = false);
        ...
        public abstract bool S6F11SendEmptyFoupRequest(string portID, List<AMCSREPORTQUEUE> reportQueues = null);
        public abstract bool S6F11SendEmptyFoupDepositFail(string portID, List<AMCSREPORTQUEUE> reportQueues = null);
