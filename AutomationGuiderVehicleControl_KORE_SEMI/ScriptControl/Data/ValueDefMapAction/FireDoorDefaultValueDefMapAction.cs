    ...
    public class FireDoorDefaultValueDefMapAction : IValueDefMapAction
    {
        ...
        public virtual void doInit()
        {
            try
            {
                ...
                if (bcfApp.tryGetReadValueEventstring(SCAppConstants.EQPT_OBJECT_CATE_EQPT, eqpt.EQPT_ID, "FIRE_DOOR_OPEN", out FireDoorOpen_vr))
                {
                    FireDoorOpen_vr.afterValueChange += (_sender, _e) => FireDoorDataChange(_sender, _e);
                }
                ValueRead FireDoorCloseGrant_vr = null;
                if (bcfApp.tryGetReadValueEventstring(SCAppConstants.EQPT_OBJECT_CATE_EQPT, eqpt.EQPT_ID, "FIRE_DOOR_CLOSE_GRANT", out FireDoorCloseGrant_vr))
                {
