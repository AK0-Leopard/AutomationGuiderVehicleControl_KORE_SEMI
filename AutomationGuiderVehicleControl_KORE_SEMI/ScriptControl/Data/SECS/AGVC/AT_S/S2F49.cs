    ...
    public class S2F49_TRANSFER : SXFY
    {
        ...
        public class REPITEM : SXFY
        {
            ...
            public class TRAN_CST : SXFY
            {
                ...
                [SecsElement(Index = 2)]
                public TRANVALUE TRANCSTINFOVALUE;


                public class TRANVALUE : SXFY
                {
                    [SecsElement(Index = 1)]
                    public CP_ASCII LOTID;
                    [SecsElement(Index = 2)]
                    public CP_ASCII CARRIERTYPE;
                }
        ...
        public ATRANSFER ToTRANSFER(BLL.PortStationBLL portStationBLL, BLL.EqptBLL eqprBLL)
        {
            ...
            string carrier_type = REPITEMS.TRANINFO_CST.TRANCSTINFOVALUE.CARRIERTYPE.CPVAL;
        ...
        {
            string lot_id = this.REPITEMS.TRANINFO_CST.TRANCSTINFOVALUE.LOTID.CPVAL;
            //string lot_id = "";
