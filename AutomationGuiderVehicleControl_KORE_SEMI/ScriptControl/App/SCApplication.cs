...
namespace com.mirle.ibg3k0.sc.App
{
    public class SCApplication
    {
        ...
        public string HPREmptyCarrierVirtualPort { get; private set; }
        ...
        private ParkAdrDao parkAdrDao = null;
        public ParkAdrDao ParkAdrDao { get { return parkAdrDao; } }
        private HPRVehicleDao hPRVehicleDao = null;
        public HPRVehicleDao HPRVehicleDao { get { return hPRVehicleDao; } }
        ...
        private void init()
        {
            ...
            HPREmptyCarrierVirtualPort = getString("HPREmptyCarrierVirtualPort", "AGV01EFP");
        ...
        {
            var sections = SectionBLL.cache.GetSections();
            foreach (var s in sections)
            {
                string from_adr = s.FROM_ADR_ID;
                string to_adr = s.TO_ADR_ID;
                var result_from = ReserveBLL.GetHltMapAddress(from_adr);
                var result_to = ReserveBLL.GetHltMapAddress(to_adr);
                if (result_from.isSuccess && result_to.isSuccess)
                {
                    double distance = getDistance(result_from.x, result_from.y, result_to.x, result_to.y);
        ...
        private void initDao()
        {
            ...
            parkAdrDao = new ParkAdrDao();
            hPRVehicleDao = new HPRVehicleDao();
        }
        ...
        private void initConfig()
        {
            ...
            if (ohxcConfig == null)
            {
                ...
                loadCSVToDataset(ohxcConfig, "PARKADR");
                loadCSVToDataset(ohxcConfig, "HPRVEHICLE");
    ...
    public class DebugParameter
    {
        ...
        public static Boolean isActiveHPRScenario = false;
    }
}
